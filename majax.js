...
function majaX(data, successcallback, errorcallback) {
  "use strict";
  var url, method, port, type, faildata, ajax, ajaxTimeout, mimes, mimetype, fileextension, regex, urlparts = {}, i = 0, pos = 0;
  ...
  urlparts.clean = {'protocol':'','domain':'','port':'','path':'','fileextension':''};
